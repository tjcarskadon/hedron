(function (global, factory) {
  ...
  (factory((global.hedron = global.hedron || {}),global.React));
...
var media = Object.keys(sizes).reduce(function (acc, label) {
  ...
  accumulator[label] = function () {
    return css(_templateObject$2, sizes[label], css.apply(undefined, arguments));
  };
  return accumulator;
}, {});
...
var passOn = function (children, ofTypes) {
  ...
  // and then process it.
  function (child) {
    return React__default.isValidElement(child) && ofTypes.includes(child.type) ? React__default.cloneElement(child, process(child)) : child;
  });
  return response;
};
...
function RowContainer(props) {
  var children = props.children,
      ...
      order = props.order,
      rest = objectWithoutProperties(props, ['children', 'tagName', 'debug', 'divisions', 'alignContent', 'alignItems', 'alignSelf', 'justifyContent', 'order']);
...
RowContainer.propTypes = {
  ...
  debug: React__default.PropTypes.bool,
  tagName: React__default.PropTypes.string,
  // grid props
  divisions: React__default.PropTypes.number,
  // flex props
  alignContent: React__default.PropTypes.string,
  alignItems: React__default.PropTypes.string,
  alignSelf: React__default.PropTypes.string,
  justifyContent: React__default.PropTypes.string,
  order: React__default.PropTypes.string,
  flexDisplay: React__default.PropTypes.string,
  flexDirection: React__default.PropTypes.string
};
...
var Row = styled(RowContainer)(_templateObject$1, function (props) {
...
function ColumnContainer(props) {
  var children = props.children,
      ...
      rest = objectWithoutProperties(props, ['children', 'tagName', 'debug', 'divisions', 'fluid', 'xs', 'sm', 'md', 'lg', 'xsShift', 'smShift', 'mdShift', 'lgShift']);
...
ColumnContainer.propTypes = {
  ...
  debug: React__default.PropTypes.bool,
  divisions: React__default.PropTypes.number,
  fluid: React__default.PropTypes.bool,
  xs: React__default.PropTypes.number,
  sm: React__default.PropTypes.number,
  md: React__default.PropTypes.number,
  lg: React__default.PropTypes.number,
  xsShift: React__default.PropTypes.number,
  smShift: React__default.PropTypes.number,
  mdShift: React__default.PropTypes.number,
  lgShift: React__default.PropTypes.number
};
...
var Page = styled(PageContainer)(_templateObject$3, function (props) {
